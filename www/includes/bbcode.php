...
function prepare_bbcode_template($bbcode_tpl)
{
	...
	// We do URLs in several different ways..
	$bbcode_tpl['famurl1'] = str_replace('{URL}', '\\1', $bbcode_tpl['famurl']);
	$bbcode_tpl['famurl1'] = str_replace('{DESCRIPTION}', '\\1', $bbcode_tpl['famurl1']);

	$bbcode_tpl['famurl2'] = str_replace('{URL}', 'http://\\1', $bbcode_tpl['famurl']);
	$bbcode_tpl['famurl2'] = str_replace('{DESCRIPTION}', '\\1', $bbcode_tpl['famurl2']);

	$bbcode_tpl['famurl3'] = str_replace('{URL}', '\\1', $bbcode_tpl['famurl']);
	$bbcode_tpl['famurl3'] = str_replace('{DESCRIPTION}', '\\2', $bbcode_tpl['famurl3']);

	$bbcode_tpl['famurl4'] = str_replace('{URL}', 'http://\\1', $bbcode_tpl['famurl']);
	$bbcode_tpl['famurl4'] = str_replace('{DESCRIPTION}', '\\3', $bbcode_tpl['famurl4']);
	
	$bbcode_tpl['email'] = str_replace('{EMAIL}', '\\1', $bbcode_tpl['email']);
	// Boris 11/11/2007 // YouTube Mod
...
function bbencode_second_pass($text, $uid)
{
	...
	**/
	...
	// matches a [famurl]xxxx://www.phpbb.com[/famurl] code..
	$patterns[] = "#\[famurl\]([\w]+?://[\w\#$%&~/.\-;:=,?@\[\]+]*?)\[/famurl\]#is";
	$replacements[] = $bbcode_tpl['famurl1'];

	// [famurl]www.phpbb.com[/famurl] code.. (no xxxx:// prefix).
	$patterns[] = "#\[famurl\]((www|ftp)\.[\w\#$%&~/.\-;:=,?@\[\]+]*?)\[/famurl\]#is";
	$replacements[] = $bbcode_tpl['famurl2'];

	// [famurl=xxxx://www.phpbb.com]phpBB[/famurl] code..
	$patterns[] = "#\[famurl=([\w]+?://[\w\#$%&~/.\-;:=,?@\[\]+]*?)\]([^?\n\r\t].*?)\[/famurl\]#is";
	$replacements[] = $bbcode_tpl['famurl3'];

	// [famurl=www.phpbb.com]phpBB[/famurl] code.. (no xxxx:// prefix).
	$patterns[] = "#\[famurl=((www|ftp)\.[\w\#$%&~/.\-;:=,?@\[\]+]*?)\]([^?\n\r\t].*?)\[/famurl\]#is";
	/* Fin update */
	//$patterns[] = "#\[url=((www|ftp)\.[^ \"\n\r\t<]*?)\]([^?].*?)\[/url\]#i";
	$replacements[] = $bbcode_tpl['famurl4'];
