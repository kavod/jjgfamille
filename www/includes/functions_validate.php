...
//
function validate_optional_fields(&$icq, &$aim, &$msnm, &$yim, &$website, &$location, &$occupation, &$interests, &$sig, &$birth_day, &$birth_month, &$birth_year)
{
	$check_var_length = array('aim', 'msnm', 'yim', 'location', 'occupation', 'interests', 'sig', 'birth_year');
	...
	{
		list($birth_day,$birth_month,$birth_year) = array(0,0,1000);
	}
