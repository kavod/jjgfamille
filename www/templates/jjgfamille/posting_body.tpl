...
<!-- Boris 11/11/2007 // Debut BBC Mod -->
<!-- BEGIN BBCODE_ROW -->
<!-- BEGIN BBCODE -->
...
<table border="0" cellpadding="0" cellspacing="0" width="99%" align="center" class="forumline">
	...
	<tr> 
		...
		<td class="row1"><span class="gen"><b>{L_NICKNAME}</b></span></td>
	...
	<tr> 
		<td class="colonneGauche"></td>
		<td width="7" class="row2"></td>
		<td class="row1" valign="top"><span class="gen"><b>{L_USERNAME}</b></span></td>
		<td class="row2"><span class="genmed"><input type="text"  class="post" name="username" maxlength="25" size="25" tabindex="1" value="{USERNAME}" />&nbsp;<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /><br />
		{CREDIT}</span></td>
		<td width="7"  class="row2"></td>
		<td class="colonneDroite"></td>
	</tr>
	...
	<tr> 
		<td class="colonneGauche"></td>
		<td width="7" class="row2"></td>
	  <td class="row1" width="200"><span class="gen"><b>{L_SUBJECT}</b></span></td>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
				  ...
				  <!-- DELETION
					...
					<!-- Boris 11/11/2007 // Update 2.0.22
					Debut OF DELETION
					</select> &nbsp;{L_FONT_SIZE}:<select name="addbbcode20" onChange="bbfontstyle('[size=' + this.form.addbbcode20.options[this.form.addbbcode20.selectedIndex].value + ']', '[/size]')" onMouseOver="helpline('f')">
					
					<!-- Fin OF DELETION
					Debut OF INSERTION // Suppression par BBC Mod-->
