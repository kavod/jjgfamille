     ...
     <tr>
      ...
      <td class="row2"><br><br>   
          <table width="99%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
	        <td><span class="genmed">{HELP}</span></td>
	      </tr>
	  </table><br><br> 
      </td>
      <td width="7" class="row2"></td>
...
<br><br>
<form action="{switch_admin.U_FORM}" method="post" name="form" enctype="multipart/form-data">    
<table align="center" width="99%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr><td valign="top" align="right"><span class="genmed"><b>{switch_admin.L_CONTENU}</b></span></td><td align="center"><textarea name="message" rows=30 cols=120 class="post">{switch_admin.HELP}</textarea></td></tr>
   <tr><td>&nbsp;</td><td align="center"><br><input type="submit" name="submit" value="{switch_admin.L_SUBMIT}"></td></tr>
</table>
<br>
</form>
</td>
