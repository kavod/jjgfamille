  ...
  <tbody>
	...
	<td class="colonneDroite"></td>
     ...
     <tr>
      <td class="colonneGauche"></td>
      <td width="7" class="row2"></td>
	<td class="row2"><br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="genmed">{ENTETE}</span><br><br>
		<table border="0" width="99%" align="center">
			<tr><td><center><b>{L_TITLE}</b></center></td></tr>
			<tr><td><br><span class="genmed"><b><u>{MID} :<u></b></td></tr>
			<tr><td><br><span class="genmed">
					<!-- BEGIN switch_midi -->
						{switch_midi.VERSION}{switch_midi.ECOUTER}
					<!-- END switch_midi -->
				   </span></td></tr>
		</table>
		<br><span class="genmed">{REAL}</span>
		<br>
	</td>
      <td width="7" class="row2"></td>
      <td class="colonneDroite"></td>
