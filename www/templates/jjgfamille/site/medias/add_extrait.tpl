     ...
     <tr>
      ...
      <form method="post" action="{U_FORM}" enctype="multipart/form-data"> 		
		<table border="0" width="80%" align="center">	
  			<tr> 
				<td><span class="genmed"><b>{L_ILLU} :</b><br><small>({EXTENSIONS})</small></span><br></td>
  			...
  			<tr> 
				<td><span class="genmed"><b>{COPYRIGHT} :</b></span><br></td>
				<td><input type="text" name="auteur" size="60" class="post"></td>
  			</tr>
  			<tr> 
				<td colspan="2"><br>
