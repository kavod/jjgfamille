    ...
    <tr>
      ...
      <td class="row2">
       ...
       <br /><table width="90%" border="0">
       		<tr>
       			<td width="70%"><span class="genmed"><i>{ACCEDEZ_TOURNEES}</i><br /><br />{STATS_TOURNEES}</span></td>
       			<td width="30%" valign="top"><span class="genmed"><b>{L_BEST_CONTRIBUTORS}</b><br />
       			<ul>
<!-- BEGIN contributors -->
				<li><a href="{contributors.U_USER}" rel="nofollow">{contributors.USERNAME}</a> {contributors.STATS}</li>
<!-- END contributors -->
			</ul></span></td>
       		</tr>
       	</table><br />
