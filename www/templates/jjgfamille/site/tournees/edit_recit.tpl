  ...
  <tbody>
	...
	<td class="colonneDroite"></td>
     ...
     <tr>
      ...
      <div align="left"><span class="genmed"><b><u>{AJOUT_RETRAN} :</u></b>&nbsp;&nbsp;<a href="{U_TITLE}">{L_TITLE}</a></span></div><br><br>
      <form method="post" action="{U_FORM}" enctype="multipart/form-data"> 		
		<table border="0" width="70%" align="center">	

  			<tr valign="top"> 
				<td><span class="genmed"><b>{RETRAN}</b></span><br></td>
				<td align="center"><textarea name="comment" cols="90" rows="20" class="post">{RECIT}</textarea><br></td>
  			</tr>
  			<tr> 
  				<td>&nbsp;</td>
				<td><br>
			...
			<tr> 
				<td colspan="2">
				<span class="genmed"><center>[&nbsp;<a href="javascript:if (confirm('{L_CONFIRM_SUPP}')) document.location='{U_SUPPRIMER}'">{L_SUPPRIMER}</a>&nbsp;]</center></span>
				</form>
				</td>
			</tr>
			</table>
