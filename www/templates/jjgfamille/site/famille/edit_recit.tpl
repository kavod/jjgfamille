...
<table align="center" width="99%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr><td valign="top" align="right"><span class="genmed"><b>{L_RECIT}</b></span></td><td align="center"><textarea name="message" rows=30 cols=120 class="post">{VAL_RECIT}</textarea></td></tr>
