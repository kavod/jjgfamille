  ...
  <tbody>
	...
	<td class="colonneDroite"></td>
     ...
     <tr>
      <td class="colonneGauche"></td>
      <td width="7" class="row2"></td>
      <td class="row2"><br><span class="cattitle"><u>{AJOUT_PHOTO} :</u></span><br>
      <form method="post" action="{U_FORM}" enctype="multipart/form-data"> 		
		<table border="0" width="80%" align="center">	
  			...
  			<tr> 
				...
				<td><input type="text" name="comment" size="50" class="post"></td>
  			</tr>
  			<tr> 
				<td><span class="genmed"><b>{L_PHOTOGRAPHE}</b></span><br></td>
				<td><input type="text" name="photographe" size="50" class="post"></td>
  			</tr>
  			<tr> 
				<td colspan="2"><br/><center><input type="submit" value="{L_SUBMIT}"></center></form></td>
			</tr>
			</table>
			<br/>
      </td>
