...
<form method="post" action="{S_SPLIT_ACTION}">
  ...
  <table width="99%" align="center" cellpadding="0" cellspacing="0" border="0" class="forumline">
	...
	<tr> 
		<td class="colonneGauche"></td>
		<td class="degradeGauche"></td>
		<th width="150" class="thLeft" nowrap="nowrap">{L_AUTHOR}</th>
		<th nowrap="nowrap">{L_MESSAGE}</th>
		<th class="thRight" nowrap="nowrap" width="100">{L_SELECT}</th>
		<td class="degradeDroite"></td>
		<td class="colonneDroite"></td>
	</tr>
	<!-- BEGIN postrow -->
	<tr> 
		...
		<td valign="top" class="{postrow.ROW_CLASS}"> 
			...
			<tr> 
				<td valign="middle"><img src="../templates/jjgfamille/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
	...
	<tr> 
		<td class="colonneGauche"></td>
		<td width="7" class="row2"></td>
	  	<td colspan="3" height="1" class="row3"><img src="templates/jjgfamille/images/spacer.gif" width="1" height="1" alt="."></td>
		<td width="7"  class="row2"></td>
		<td class="colonneDroite"></td>
	</tr>
	<!-- END postrow -->
