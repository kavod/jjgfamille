...
<table class="forumline" width="99%" cellspacing="0" cellpadding="0" border="0" align="center">
    <tr>
  ...
  <tr> 
	...
	<th class="thHead" colspan="3" height="25" nowrap="nowrap">{L_VIEWING_PROFILE}</th>
  ...
  <tr> 
	...
	<td class="catLeft" width="250" height="28" align="center"><b><span class="gen">{L_AVATAR}</span></b></td>
	...
	<td class="catRight" width="150"><b><span class="gen">{L_PHOTO}</span></b></td>
      <td width="7"  class="row2"></td>
      <td class="colonneDroite"></td>
  </tr>
  <tr> 
	...
	<td class="row1" rowspan="3" valign="top"><table border="0" cellspacing="1" cellpadding="3">
		<tr> 
	...
	<td class="row1" rowspan="3" valign="middle" width="200" align="center"><img src="{PHOTO}" border="0"></td>
      <td width="7"  class="row2"></td>
      <td class="colonneDroite"></td>
  </tr>
  <tr> 
  ...
  <tr> 
      <td class="colonneGauche"></td>
      <td width="7" class="row2"></td>
	<td class="row1" valign="top"><table border="0" cellspacing="1" cellpadding="3">
		<tr> 
    ...
    <tr>
      <td colspan="3" height="5" class="ligneBas"></td>
    </tr>
</table>
