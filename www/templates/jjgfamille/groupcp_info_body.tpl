...
<table class="forumline" width="99%" align="center" cellspacing="0" cellpadding="0" border="0">
    <tr>
      ...
      <td colspan="2" height="5" class="ligneHaut"></td>
	...
	<tr> 
		...
		<th class="thHead" colspan="2" height="25">{L_GROUP_INFORMATION}</th>
    ...
    <tr>
      <td colspan="2" height="5" class="ligneBas"></td>
    </tr>
</table><br />
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0" class="forumline">
    <tr>
      <td colspan="2" rowspan="2" class="coinHG"></td>
      <td colspan="7" height="5" class="ligneHaut"></td>
      <td colspan="2" rowspan="2" class="coinHD"></td>
    </tr>
    <tr>
	...
	<tr> 
		<td class="colonneGauche"></td>
		<td width="7" class="row2"></td>
	  	<td class="catHead" colspan="7" height="28"><span class="cattitle">{L_GROUP_MODERATOR}</span></td>
		<td width="7"  class="row2"></td>
		<td class="colonneDroite"></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td class="colonneGauche"></td>
		<td width="7" class="row2"></td>
	  <td class="catHead" colspan="7" height="28"><span class="cattitle">{L_GROUP_MEMBERS}</span></td>
		<td width="7"  class="row2"></td>
		<td class="colonneDroite"></td>
	</tr>
	<!-- BEGIN member_row -->
    ...
    <tr>
      <td colspan="7" height="5" class="ligneBas"></td>
    </tr>
</table>
