...
<link rel="stylesheet" href="../templates/jjgfamille/blogs/blogs.css" type="text/css" />
...
.coinHG		{ width:12px; height:12px; background-image:url(../templates/jjgfamille/images/site/coin_hg.gif); padding: 0px; }
.coinHD		{ width:12px; height:12px; background-image:url(../templates/jjgfamille/images/site/coin_hd.gif); padding: 0px; }
.coinBG		{ width:12px; height:12px; background-image:url(../templates/jjgfamille/images/site/coin_bg.gif); padding: 0px; }
.coinBD		{ width:12px; height:12px; background-position: right; overflow: hidden; background-image:url(../templates/jjgfamille/images/site/coin_bd.gif); padding: 0px; }

.ligneHaut	{ height:5px; background-image:url(../templates/jjgfamille/images/site/lig_h2.gif); padding: 0px;}
.ligneBas	{ height:5px; background-image:url(../templates/jjgfamille/images/site/lig_b2.gif); padding: 0px; }
.colonneGauche	{ width:5px; background-image:url(../templates/jjgfamille/images/site/col_g2.gif); padding: 0px; }
.colonneDroite	{ width:5px; background-image:url(../templates/jjgfamille/images/site/col_d2.gif); padding: 0px; }
...
<div id="tlogo">
	<table class="fboite">
		...
		<tr>
			<td colspan="2" style="width:150px; height:41px; vertical-align: middle; text-align: left;">
...
<div id="tmenu">
	<table class="fboite">
		...
		<tr>
			<td style="height:41px" class="colonneGauche"></td>
			<td style="vertical-align:middle; text-align:center; width:300px; height:41px" class="row2" colspan="2">
		...
		<tr>
			...
			<td style="height:7px; width:293px;" class="row2"></td>
		</tr>
		<tr>
			<td style="width:293px" class="ligneBas"></td>
		</tr>
	</table>
</div>
<table id="tcontent">
