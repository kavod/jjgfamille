...
<form method="post" action="{S_POST_DAYS_ACTION}">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="99%" class="forumline">
	<tr>
		<td colspan="2" rowspan="2" class="coinHG"></td>
		<td colspan="6" class="ligneHaut"></td>
		<td colspan="2" rowspan="2" class="coinHD"></td>
	</tr>
	<tr>
		<td colspan="6" height="7" class="row2"></td>
	</tr>
	<tr> 
	  ...
	  <th width="170" align="center" class="thCornerR" nowrap="nowrap">&nbsp;{L_LASTPOST}&nbsp;</th>
	...
	<td width="7" class="row2"></td>
	  <td class="row1" align="center" valign="middle" width="30" height="30"><img src="{topicrow.TOPIC_FOLDER_IMG}" width="33" height="25" alt="{topicrow.L_TOPIC_FOLDER_ALT}" title="{topicrow.L_TOPIC_FOLDER_ALT}" /></td>
	  <td class="row1"><span class="topictitle">&nbsp;{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
	...
	<tr>
		<td colspan="6" class="ligneBas"></td>
	</tr>
  </table>
