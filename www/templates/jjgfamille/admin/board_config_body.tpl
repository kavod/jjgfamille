...
<!-- Fin update -->
   ...
   <tr> 
	...
	<tr>
		<th class="thHead" colspan="2">{L_SITEMAP_SETTINGS}</th>
	</tr>
	<tr> 
		<td class="row1">{L_TOPIC_LIMIT}<br /><span class="gensmall">{L_TOPIC_LIMIT_EXPLAIN}</span></td> 
		<td class="row2"><input type="text" name="sitemap_topic_limit" value="{TOPIC_LIMIT}" /></td> 
	</tr>
	<tr> 
		<td class="row1">{L_ANNOUNCE_PRIORITY}<br /><span class="gensmall">{L_ANNOUNCE_PRIORITY_EXPLAIN}</span></td> 
		<td class="row2"><input type="text" name="sitemap_announce_priority" value="{ANNOUNCE_PRIORITY}" /></td> 
	</tr>
	<tr> 
		<td class="row1">{L_STICKY_PRIORITY}<br /><span class="gensmall">{L_STICKY_PRIORITY_EXPLAIN}</span></td> 
		<td class="row2"><input type="text" name="sitemap_sticky_priority" value="{STICKY_PRIORITY}" /></td> 
	</tr>
	<tr> 
		<td class="row1">{L_DEFAULT_PRIORITY}<br /><span class="gensmall">{L_DEFAULT_PRIORITY_EXPLAIN}</span></td> 
		<td class="row2"><input type="text" name="sitemap_default_priority" value="{DEFAULT_PRIORITY}" /></td> 
	</tr>
	<tr>
		<td class="row1">{L_SORT_ORDER}</td>
		<td class="row2"><input type="radio" name="sitemap_sort" value="DESC" {SITEMAP_SORT_DESC} /> {L_NEW_FIRST}&nbsp;&nbsp;<input type="radio" name="sitemap_sort" value="ASC" {SITEMAP_SORT_ASC} /> {L_OLD_FIRST}</td>
	</tr>  
	<tr>
