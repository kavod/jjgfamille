...
$sitemap_sort_desc = ( $new['sitemap_sort'] == "DESC" ) ? "checked=\"checked\"" : "";
$sitemap_sort_asc = ( $new['sitemap_sort'] == "ASC" ) ? "checked=\"checked\"" : "";
...
$template->assign_vars(array(
	...
	"L_SITEMAP_SETTINGS" => $lang['Sitemap_settings'],
	"L_TOPIC_LIMIT" => $lang['Topic_limit'],
	"L_TOPIC_LIMIT_EXPLAIN" => $lang['Topic_limit_explain'],
	"L_ANNOUNCE_PRIORITY" => $lang['Announce_priority'],
	"L_ANNOUNCE_PRIORITY_EXPLAIN" => $lang['Announce_priority_explain'],
	"L_STICKY_PRIORITY" => $lang['Sticky_priority'],
	"L_STICKY_PRIORITY_EXPLAIN" => $lang['Sticky_priority_explain'],
	"L_DEFAULT_PRIORITY" => $lang['Default_priority'],
	"L_DEFAULT_PRIORITY_EXPLAIN" => $lang['Default_priority_explain'],
	"L_SORT_ORDER" => $lang['Sort_order'],
	"L_NEW_FIRST" => $lang['New_first'],
	"L_OLD_FIRST" => $lang['Old_first'],
