...
if( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'left' )
{
	...
	$template->assign_vars(array(
		"U_FORUM_INDEX" => append_sid($phpbb_root_path . "forum/index.$phpEx"),
		"U_ADMIN_INDEX" => append_sid($phpbb_root_path . "admin/index.$phpEx?pane=right"),
...
elseif( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'right' )
{
	...
	if( count($onlinerow_reg) )
	{
		...
		for($i = 0; $i < count($onlinerow_reg); $i++)
		{
			if( !inarray($onlinerow_reg[$i]['user_id'], $reg_userid_ary) )
			{
				...
				{
					list($location,$location_url) = get_location($onlinerow_reg[$i]['user_session_page']);
				...
				{
					$location_url = append_sid($phpbb_root_path . "admin/admin_forums.$phpEx?mode=editforum&amp;" . POST_FORUM_URL . "=" . $onlinerow_reg[$i]['user_session_page']);
				...
				$template->assign_block_vars("reg_user_row", array(
					...
					"U_USER_PROFILE" => append_sid($phpbb_root_path . "admin/admin_users.$phpEx?mode=edit&amp;" . POST_USERS_URL . "=" . $onlinerow_reg[$i]['user_id']),
	...
	if( count($onlinerow_guest) )
	{
		...
		for($i = 0; $i < count($onlinerow_guest); $i++)
		{
			...
			{
				list($location,$location_url) = get_location($onlinerow_guest[$i]['session_page'] );
...
else
{
	...
	$template->assign_vars(array(
		"S_FRAME_NAV" => append_sid($phpbb_root_path . "admin/index.$phpEx?pane=left"),
		"S_FRAME_MAIN" => append_sid($phpbb_root_path . "admin/index.$phpEx?pane=right"))
	);
