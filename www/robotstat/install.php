...
$sql = "INSERT INTO ".$RS_TABLE_ROBOTS." VALUES (7, 1, 'Slurp', '216.35.116.', '', 'Slurp (Inktomi)', 'detection_ip', 'Robot utilisé par Inktomi', 'Spider for http://www.inktomi.com partner sites', '');";
$res  = mysql_query( $sql ) or erreurServeurMySQL( $sql );
...
$sql = "INSERT INTO ".$RS_TABLE_ROBOTS." VALUES (184, 1, 'MSNBOT/0.1 (http://search.msn.com/msnbot.htm)', '131.107.', '', 'MSN Bot', 'detection_ip', 'Robot qui alimentera peut-être un moteur de recherche de Microsoft... MSN ?', 'Maybe the next MSN spider robot...', 'http://search.msn.com/msnbot.htm');";
$res  = mysql_query($sql) or erreurServeurMySQL($sql);
