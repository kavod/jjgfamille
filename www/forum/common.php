...
include($phpbb_root_path . 'forum/config.'.$phpEx);
...
{
	?><html><body>Un probl&egrave;me technique, dû à notre hébergeur, nous oblige à temporairement fermer le site / forum JJGfamille.<br />Nous nous excusons de la gène occasionnée et nous espérons pouvoir rouvrir au plus vite.<br />Merci de votre compréhension.<br /><br /> Boris KAVOD administrateur JJGfamille.com</body></html><?
	die();
