					...
					if ( $forum_data[$j]['cat_id'] == $cat_id )
					{
						...
						if ( $is_auth_ary[$forum_id]['auth_view'] )
						{
							...
							$template->assign_block_vars('catrow.forumrow',	array(
								...
								'U_VIEWFORUM' => append_sid($phpbb_root_path . "forum/viewforum.$phpEx?" . POST_FORUM_URL . "=" . $forum_id . add_title_in_url($forum_data[$j]['forum_name'], $userdata['session_logged_in'])))
