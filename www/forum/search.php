...
include($phpbb_root_path . 'functions/functions_selections.'.$phpEx);
	...
	if ( $search_id == 'newposts' || $search_id == 'egosearch' || $search_id == 'unanswered' || $search_keywords != '' || $search_author != '' )
	{
		...
		if ( $search_id == 'newposts' || $search_id == 'egosearch' || ( $search_author != '' && $search_keywords == '' )  )
		{
			if ( $search_id == 'newposts' )
			{
				...
				{
					redirect(append_sid("forum/login.$phpEx?redirect=forum/search.$phpEx&search_id=newposts", true));
				}
			...
			else if ( $search_id == 'egosearch' )
			{
				...
				{
					redirect(append_sid("forum/login.$phpEx?redirect=forum/search.$phpEx&search_id=egosearch", true));
				}
