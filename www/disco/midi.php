...
$entete .= '<a href="goldman_midi_' . $song_id . '_'.$album_id.'_' . url_title($val_song['title']) . '.html"><b>'.$lang['Fichier midi'].'</b></a>';	
...
$page_title = $lang['Fichier midi'] . ' :: ' . $val_song['title'];
include($phpbb_root_path . 'includes/page_header.'.$phpEx);


$template->set_filenames(array(
	'body' => 'site/disco/midi.tpl',
...
$template->assign_vars(array(
				...
				"U_LIST_SONG" => append_sid($phpbb_root_path . 'disco/liste_chansons.html'),
...
for ($i=0;$asso[$i]!="";$i++)
	{
		if (is_file("../audio/disco/midi_".$asso[$i].".mid"))
		{
			...
			$onclick = "window.open('../fmc/jukebox.php?mode=midi&id=".$asso[$i]."','Jukebox','noresizable,scrollbars=yes,menubar=auto,width=800,height=500,left=100,top=100')";
