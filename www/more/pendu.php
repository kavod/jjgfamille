...
$val_more = select_element("SELECT * FROM more WHERE file = 'pendu.php' ",'',false);
//
...
$page_title = $lang['EnPlusPlus'].' :: '.$lang['Jeux'].' :: Le pendu';
include($phpbb_root_path . 'includes/page_header.'.$phpEx);


$template->set_filenames(array(
	'body' => 'site/more/pendu.tpl',
...
$template->assign_vars(array(
				...
				"TITLE" => 'Titre de la chanson à trouver',
