...
$lang['Forum_Index'] = '%s Index du Forum';  
...
$lang['Click_return_topic'] = 'Cliquez %sici%s pour retourner au sujet de discussion'; 
...
$lang['Board_disable'] = 'Désolé, mais ce forum est actuellement indisponible. Veuillez réessayer dans quelques minutes.';
...
$lang['Record_online_users'] = 'Le record du nombre d\'utilisateurs en ligne est de <b>%s</b> le %s'; 
...
$lang['You_last_visit'] = 'Dernière visite le %s'; 

// %s replaced by date/time
$lang['Current_time'] = 'Nous sommes le %s'; 
...
$lang['Single_Happy_birthday'] = 'Bon anniversaire à ';
$lang['Several_Happy_birthday'] = 'Bons anniversaires à ';
$lang['And'] = ' et ';
$lang['Number_of_visitor'] = 'Vous êtes le %sè visiteur';
$lang['the_website'] = 'Le site';
$lang['the_webchat'] = 'Le chat';
$lang['the_forum'] = 'Le forum';
$lang['Welcome'] = 'Bienvenue';
$lang['Welcome_Here'] = $lang['Welcome'].' sur famille';
$lang['Your_account'] = 'Votre compte';
$lang['Unread_msgs'] = 'Et %s messages forum non lus';
$lang['Unread_msg'] = 'Et %s message forum non lu';

//
// Stats block text
//
$lang['Posted_articles_zero_total'] = 'Nos membres ont posté un total de <b>0</b> message'; 

// Number of posts
$lang['Posted_articles_total'] = 'Nos membres ont posté un total de <b>%d</b> messages'; 

// Number of posts
$lang['Posted_article_total'] = 'Nos membres ont posté un total de <b>%d</b> message'; 

// Number of posts
$lang['Registered_users_zero_total'] = 'Il n\'y a aucun inscrit'; 

// # registered users
$lang['Registered_users_total'] = 'Il y a <b>%d</b> membres inscrits'; 

// # registered users
$lang['Registered_user_total'] = 'Il y a <b>%d</b> membre inscrit'; 

// # registered users
$lang['Newest_user'] = 'L\'utilisateur enregistré le plus récent est <b>%s%s%s</b>'; 
...
$lang['Log_me_in'] = 'Identification auto';
...
$lang['Rules_moderate'] = 'Vous <b>pouvez</b> %smodérer ce forum%s'; 
...
$lang['Edited_time_total'] = 'Dernière édition par %s le %s; édité %d fois'; 

// Last edited by me on 12 Oct 2001, edited 1 time in total
$lang['Edited_times_total'] = 'Dernière édition par %s le %s; édité %d fois'; 
...
$lang['No_post_mode'] = 'Mode du sujet non spécifié'; 
...
$lang['BBCode_is_ON'] = 'Le %sBBCode%s est <u>Activé</u>'; 
...
$lang['New_pms'] = '<b>Vous avez %d nouveaux MP</b>'; 

// You have 2 new messages
$lang['New_pm'] = '<b>Vous avez %s nouveau MP</b>'; 

// You have 1 new message
$lang['No_new_pm'] = 'Vous n\'avez pas de MP';
...
$lang['Display_messages'] = 'Montrer les messages depuis'; 

// Followed by number of days/weeks/months
...
// Boris 13/05/2006
// Mesures anti-spam
$lang['Not_enough_credit'] = "Désolé, mais vous ne possédez pas un crédit de posts suffisant pour envoyer un message privé.<br />Pour augmenter votre crédit, participez à la vie du forum en postant des messages sur les sujets publics.";
$lang['PM_credit'] = "Votre crédit de message privés est %s.";
$lang['PM_nb_msg'] = "de %s messages";
$lang['unlimited'] = "illimité";
$lang['Know_more'] = "En savoir plus";
// fin de modif
...
$lang['Inbox_size'] = 'Votre Boîte de réception est pleine à %d%%'; 

// eg. Your Inbox is 50% full
...
//
$lang['Viewing_user_profile'] = 'Voir le profil :: %s'; 

// %s is username 
$lang['About_user'] = 'Tout à propos de %s'; 
...
$lang['Photo_panel'] = 'Panneau de contrôle des photographies';
...
$lang['Birthday_explain'] = 'L\'année de votre date de naissance n\'apparait pas sur le forum. Elle sert uniquement pour les statistiques personnelles du site famille.';
$lang['Total_posts'] = 'Messages';
$lang['User_post_pct_stats'] = '%.2f%% du total'; 

// 1.25% of total
$lang['User_post_day_stats'] = '%.2f messages par jour';

// 1.5 posts per day
$lang['Search_user_posts'] = 'Trouver tous les messages de %s';
...
$lang['Photo_explain'] = 'Ajoute votre photo au trombinoscope. Seule une photo peut être affichée à la fois, la taille du fichier ne doit pas dépasser %d ko.';
$lang['Upload_Avatar_file'] = 'Envoyer l\'Avatar depuis votre ordinateur';
$lang['Upload_Photo_file'] = 'Envoyer la photo depuis votre ordinateur';
...
$lang['Avatar_filesize'] = 'La taille de l\'image de l\'avatar doit être inférieure à %d ko'; 

// The avatar image file size must be less than 6 ko
$lang['Avatar_imagesize'] = 'La taille de l\'avatar doit être de %d pixels de largeur et de %d pixels de hauteur'; 
$lang['Welcome_subject'] = 'Bienvenue sur les Forums de %s'; 

// Welcome to my.com forums
...
$lang['Group_auto'] = 'Groupe automatique';
...
$lang['This_auto_group'] = 'Ceci est un groupe sans demande d\'approbation. Cliquez pour vous inscrire';
...
$lang['Return_first'] = 'Retourner les'; 

// followed by xxx characters in a select box
$lang['characters_posts'] = 'premiers caractères des messages';
$lang['Search_previous'] = 'Rechercher depuis'; 

// followed by days, weeks, months, year, all in a select box
...
$lang['Found_search_match'] = '%d résultat trouvé'; 

// eg. Search found 1 match
$lang['Found_search_matches'] = '%d résultats trouvés'; 
// eg. Search found 24 matches
$lang['Close_window'] = 'Fermer la Fenêtre';

// Boris 19/05/2006
// Update 2.0.20
$lang['Search_Flood_Error'] = 'Vous ne pouvez faire une autre recherche juste après la précédente. Merci de réessayer dans quelques instants.';
// fin update
...
// Viewonline
//
$lang['Reg_users_zero_online'] = 'Il y a 0 utilisateur enregistré et '; 

// There are 5 Registered and
$lang['Reg_users_online'] = 'Il y a %d utilisateurs enregistrés et '; 

// There are 5 Registered and
$lang['Reg_user_online'] = 'Il y a %d utilisateur enregistré et '; 

// There is 1 Registered and
$lang['Hidden_users_zero_online'] = '0 utilisateur invisible en ligne'; 

// 6 Hidden users online
$lang['Hidden_users_online'] = '%d utilisateurs invisibles en ligne'; 

// 6 Hidden users online
$lang['Hidden_user_online'] = '%d utilisateur invisible en ligne'; 

// 6 Hidden users online
$lang['Guest_users_zero_online'] = 'Il y a 0 invité en ligne'; 

// There are 10 Guest users online
$lang['Guest_users_online'] = 'Il y a %d invités en ligne'; 

// There are 10 Guest users online
$lang['Guest_user_online'] = 'Il y a %d invité en ligne'; 
...
$lang['Viewing_Contact'] = 'Est sur la page de contact';
$lang['Viewing_accueil'] = 'Admire la page d\'accueil';
$lang['Viewing_liens'] = 'Regarde la rubrique liens';
$lang['Viewing_actu'] = 'Épluche l\'actualité Goldmanienne';
$lang['Viewing_jjg'] = 'Regarde la rubrique jjg';
$lang['Viewing_medias'] = 'Regarde la rubrique medias';
$lang['Viewing_tournees'] = 'Regarde la rubrique tournées';
$lang['Viewing_more'] = 'Regarde la rubrique En ++';
$lang['Viewing_famille'] = 'Regarde la rubrique famille';
$lang['Viewing_chat'] = 'Regarde le chat famille';
$lang['Viewing_fmc'] = 'Ecoute des extraits avec le famille media center';
$lang['Viewing_blogs'] = 'Surf sur les blogs famille';
...
$lang['cause_of_move'] = 'Raison du déplacement de sujet';
$lang['has_been_moved'] = 'Ce sujet a été déplacé par [b:%s]%s[/b:%s] pour les raisons suivantes : ';
$lang['move_notification'] = "Modération de votre message";
...
//
$lang['All_times'] = 'Toutes les heures sont au format %s'; 

// eg. All times are GMT - 12 Hours (times from next block)
...
$lang['Unknown_error_message'] = 'Désolé une erreur inconnue est arrivée'; 
$lang['error_401'] = 'Erreur 401 - Mot de passe Incorrect'; 
$lang['error_401_message'] = 'Vous avez spécifié un nom d\'utilisateur incorrect ou inactif ou un mot de passe invalide.'; 
$lang['error_403'] = 'Erreur 403 - Accès refusé'; 
$lang['error_403_message'] = 'Désolé vous n\'avez pas les droits appropriés de voir cette page.'; 
$lang['error_404'] = 'Erreur 404 - Non Trouvé'; 
$lang['error_404_message'] = 'Erreur 404, Désolé la page que vous cherchez n\'existe pas. Demandez au Webmaster ou à un admin de vous aidez !';
$lang['error_500'] = 'Erreur 500 - Erreur Interne du Serveur'; 
$lang['error_500_message'] = 'Une Erreur Interne du Serveur est arrivée.<br />Si le rechargement de la page n\'aide pas, demandez au Webmaster ou à un Admin de vous aidez !.';$lang['Admin_reauthenticate'] = 'Pour administrer le forum, vous devez vous authentifier de nouveau.';

$lang['n_cnil']='1116048';

//Module Watch Topics
$lang['Watched_Topics'] = 'Sujet surveillé';
$lang['No_Watched_Topics'] = 'Vous ne surveillez aucun sujet';
$lang['Watched_Topics_Started'] = 'Sujet démarré';
$lang['Watched_Topics_Stop'] = 'Arrêter de surveiller';
$lang['Check_All'] = 'Sélectionner tous';
$lang['UnCheck_All'] = 'Déselectionner tous';

//Google
$lang['google_track_rapport'] = 'Rapport des visites de Google';
$lang['google_last_visit'] = 'Dernières visites de Google, pages vues';
$lang['erase'] = 'Effacer le rapport';
$lang['Google_Visit_counter'] = 'Google est venu <b>%d</b> fois sur ce forum depuis le 14 juin 2003';

// Bot log
$lang['Registered_bot'] = 'Bot de moteurs de recherche parcourant le forum: ';
$lang['Bot_online_color'] = '%sBot%s';

$lang['Login_attempts_exceeded'] = 'Le nombre maximum de tentative d\'identification a été dépassé (%s essais). Vous serez de nouveau autorisé à vous identifier dans %s minutes. Merci de prévenir les administrateurs de famille si vous n\'êtes pas responsable de ces essais infructueux.';
$lang['Please_remove_install_contrib'] = 'Merci de vous assurez que les répertoires install/ et contrib/ ont bien été supprimés';
$lang['Session_invalid'] = 'Session invalide. Merci de resoumettre les informations.';

// Contacts
$lang['warning_about_contact'] = "Avant de nous envoyer un message merci de prendre en note que <b>nous n'avons aucun contact avec Jean-Jacques Goldman</b><br />Pour lui écrire, envoyez votre courrier à :<br />
JSM Music<br />
18, rue de Saisset<br />
92120 Montrouge";

// Blogs
$lang['Blogs'] = 'Les blogs famille';
$lang['the_weblogs'] = 'Les blogs';
$lang['Blogs_subtitle'] = 'Votre blog sur JJGfamille';
$lang['Blogs_presentation'] = "JJGfamille vous offre à présent la possibilité de créer votre blog.<br /><br />Voici les derniers articles publiés sur les blogs famille";
$lang['Who_am_I'] = "Qui suis-je ?";
$lang['my_famille_profile'] = "Mon profile famille :";
$lang['blog_no_comment'] = "pas de commentaire";
$lang['blog_1_comment'] = "1 commentaire";
$lang['blog_x_comments'] = "%s commentaires";
$lang['famille_user_identify'] = "Utilisateur de famille ? %sIdentifiez-vous%";
$lang['Leave_your_comment'] = "Laissez votre commentaire";
$lang['Sorry_auth_owner'] = 'Désolé, mais seul le propriétaire de ce blog peut ajouter un article sur celui-ci.';
$lang['Sorry_no_blog'] = 'Désolé, mais vous ne possédez pas de blog';
$lang['Sorry_not_blog_admin'] = "Désolé, mais vous n'êtes pas autorisé à administrer la rubrique blogs";
$lang['blog_admin'] = 'Administration de votre blog';
$lang['Admin_a_blog'] = 'Administration d\'un blog';
$lang['Admin_of_blog'] = 'Administration du blog';
$lang['General_settings'] = 'Administration Générale';
$lang['Config_blog'] = "Configurer %s";
$lang['Blog_title'] = 'Titre du blog';
$lang['Subtitle'] = 'Sous titre';
$lang['Presentation'] = 'Présentation';
$lang['Properties_edited'] = "Les propriétés de votre blog ont bien été pris en compte<br />Cliquez %sici%s pour retourner à l'administration de votre blog";
$lang['Post_new_article'] = "Ecrire un nouvel article dans";
$lang['Blog_created'] = "Votre blog a bien été créé<br />Cliquez %sici%s pour retourner à l'administration de votre blog";
$lang['My_articles'] = 'Mes articles';
$lang['The_bloggers'] = 'Les bloggers famille';
$lang['Blogger'] = "Blogger";
$lang['by'] = 'par';
$lang['view_my_blog'] = 'Se rendre sur votre blog';
$lang['Your_blog_on_famille'] = 'Créez votre blog JJGfamille';
$lang['Blog_already_exists'] = "Votre blog existe déjà";
$lang['Cate_mandatory'] = "Vous devez créer une catégorie";
$lang['Cate_deleted'] = "Catégorie supprimée<br />Cliquez %sici%s pour retourner à l'administration de votre blog";
$lang['Comments'] = "Commentaires";
$lang['Explain_presentation'] = "Présentation du sujet de votre blog";
$lang['Explain_profil'] = "Présentation de vous même";
$lang['Links'] = "Liens";
$lang['Add_category'] = "Ajouter une nouvelle catégorie";
$lang['Category'] = 'Catégories';
$lang['Archives'] = 'Archives';
$lang['Nickname'] = "Pseudo";
$lang['Switch_activation_rub'] = "Activation de la rubrique";
$lang['Switch_readonly'] = "Mise en lecture seule";
$lang['Switch_enable'] = "Activation du blog";
$lang['Has_no_blog'] = "%s n'a pas de blog";
$lang['Caution_inactiv_blog'] = "<b>ATTENTION :</b> ce blog est inactif. Les articles ne sont visibles que par son propriétaire.";
$lang['Explain_readonly'] = "Cette option désactive la capacité de poster de commentaires";
$lang['Force'] = "Forcer %s";
$lang['Blog_readonly'] = "Ce blog est en lecture seule";
$lang['Blogs_disable'] = "Rubrique blog indisponible pour le moment.<br /><a href=\"%s\">Retour au site</a>";
$lang['Configuration_edited'] = "La configuration de la rubrique blog a bien été prise en compte<br />Cliquez %sici%s pour retourner à l'administration des blogs";
$lang['Calendar'] = "Calendrier";
$lang['Boxes'] = "Boites";
$lang['Up'] = "Monter";
$lang['Down'] = "Descendre";
$lang['Blogs_no_article'] = "Aucun article ne correspond aux critères";
$lang['Last_coms'] = "Derniers commentaires";
$lang['In'] = '%s dans %s';
$lang['Blogs_Articles_Moved'] = 'Le(s) article(s) sélectionné(s) a/ont été déplacé(s).';
$lang['Blogs_No_Articles_Moved'] = 'Aucun article n\'a été déplacé.';
$lang['Blogs_Click_return_article'] = 'Cliquez %sici%s pour retourner à l\'article du blog'; 
$lang['Click_return_blog'] = 'Cliquez %sici%s pour retourner au blog'; 
$lang['Confirm_move_blog_article'] = 'Etes-vous sûr de vouloir déplacer le(s) article(s) sélectionné(s) ?';
$lang['Move_to_cate'] = 'Déplacer vers la catégorie';
$lang['Confirm_X'] = 'Etes-vous sûr de vouloir %s ?';
$lang['Blog_deleted'] = "Blog supprimé<br />Cliquez %sici%s pour retourner à l'administration des blogs";
$lang['Blog_Index'] = '%s Index des Blogs';
$lang['Blogs_cate_delete'] = 'Supprimer une catégorie';
$lang['Blogs_cate_delete_explain'] = 'Le formulaire ci-dessous vous permettra de supprimer une catégorie et décider où vous voulez mettre les articles qu\'il contenait.';
$lang['Move_contents'] = 'Déplacer tout le contenu vers';
$lang['Cate_name'] = 'Nom de la catégorie';
$lang['Delete_all_posts'] = 'Supprimer tous les messages';
$lang['Switch_notification'] = 'Recevoir un email à chaque commentaire ?';
$lang['Import_rss'] = "Importation RSS";
$lang['Syndication_URL'] = "URL du fil";
$lang['Import_Synchronize'] = "Importer / Synchroniser";
...
$lang['Error_poll_early'] = 'Ce sondage a été créé avant l\'amélioration du système de vote du 12/02/2007, les nouvelles fonctionnalités sont donc inactives.';
$lang['Error_poll_query'] = 'Impossible d\'obtenir les sondages';
$lang['Export_csv'] = 'Exporter les informations en fichier CVS';
$lang['Poll_expires'] = 'Ce sondage se termine dans ';
$lang['Poll_expired'] = 'Ce sondage est terminé.'; 
$lang['Poll_hidden'] = 'Les résultats détaillés ont été désactivés dans ce sondage.';
$lang['Poll_noexpire'] = 'Ce sondage n\'a pas de date limite'; 
$lang['Poll_no_undo'] = 'La modification de vos votes a été désactivée.';
$lang['Poll_return'] = 'Pour revenir aux résultats du vote, cliquez %sici%s';
$lang['Minute'] = 'Minute';
$lang['Minutes'] = 'Minutes';
$lang['No_votes'] = 'Personne n\'a voté pour ce choix';
$lang['Remove_votes'] = 'Etes-vous sûr de vouloir retiré ces votes ?';
$lang['Results_after'] = 'Les résultats ne seront visibles qu\'après la fin du vote';
$lang['Sort_by_option'] = 'Votes listés par choix';
$lang['Sort_by_question'] = '(rangé par question)';
$lang['Sort_by_topic'] = '(rangé par sujet)';
$lang['Sort_by_user'] = 'Votes listés par utilisteurs';
$lang['Total_votes'] = 'Total des votes : ';
$lang['Undo_no_votes'] = 'Vous n\'avez pas encore voté!';
$lang['Undo_vote'] = '[ retirer ]';
$lang['Voted_show'] = 'Utilisateurs votants : ';
$lang['Votes_removed'] = 'Les votes ont été supprimés avec succès';
$lang['Already_voted'] = 'Vous avez déjà voté dans ce sondage, ou vous avez tenté de choisir trop d\'options à la fois.';
$lang['Day'] = 'Jour';
$lang['Allow_undo'] = 'Autoriser la modification du vote';
$lang['Also_hide_simple'] = 'Cacher les résultats (jusqu\'à la fin du vote)';
$lang['Also_hide_voters'] = 'Cacher le nombre de votants (jusqu\'à la fin du vote)';
$lang['Hide_detailed_results'] = 'Cacher les résultats détaillés';
$lang['Hide_vote'] = 'Résultats';
$lang['Hide_vote_explain'] = '[ Cacher jusqu\'à la fin du sondage ]';
$lang['Max_vote'] = 'Sélections maximum';
$lang['Max_vote_explain'] = '[ Sasir 1 ou laissez blanc pour n\'autoriser qu\'un unique choix ]';
$lang['Max_voting_1_explain'] = 'Merci de sélectionner au plus ';
$lang['Max_voting_2_explain'] = ' choix';
$lang['Undo_votes'] = 'Annuler les votes';
$lang['Until_exp'] = 'jusqu\'à la fin du vote';
$lang['Vhide'] = 'Cacher';
